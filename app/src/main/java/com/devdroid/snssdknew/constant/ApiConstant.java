...
public class ApiConstant {
    ...
    //图片接口
    public static final String GET_SNSSDK_IMAGE_URL_FRESH = "http://iu.snssdk.com/neihan/stream/category/data/v2/?mpic=1&webp=1&category_id=12&level=6&count=30&iid=11285516691&device_id=%s";
}
